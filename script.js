...
function generatePassword() {
  ...
  if(!passwordLength) {
    ...
    confirmLower = confirm("Would you like the password to contain lower case letters?");
    console.log("Lower case " + confirmLower);
    confirmUpper = confirm("Would you like the password to contain upper case letters?");
